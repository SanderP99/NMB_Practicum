...
legend({'$f(x) = \frac{1}{25x^2+1}$', '$V_2$','$V_4$', '$V_6$', '$V_8$', '$V_{10}$', '$V_{12}$', '$V_{14}$', '$V_{16}$', '$V_{18}$', '$V_{20}$'}, 'interpreter', 'latex', 'location', 'south', 'NumColumns', 3, 'FontSize', 14,'FontWeight', 'normal', 'FontName', 'Times');
hold off
